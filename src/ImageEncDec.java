...
public class ImageEncDec extends javax.swing.JFrame {
    ...
    ImageEncryptionDecryptionAlgorithm ieda;
    public ImageEncDec() {
        ieda = new ImageEncryptionDecryptionAlgorithm();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Encrypted / Decrypted Image");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
      ...
      { 
         ...
         File fnew = new File("C:\\Users\\NitinSinha\\Desktop\\Encrypted.png");
         
         if(f.length() != 0)
         {
             ieda.encrypt(key , f , fnew);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
          try
         {
             ...
             File f2 = new File("C:\\Users\\NitinSinha\\Desktop\\Decrypted.png");
             
             if(f1.length() != 0)
             {
                 ieda.Decrypt(key , f1 , f2);
